...
const projects = [
  {
    ...
    image: "/assets/work/KOS.svg",
    live: 'https://drive.google.com/file/d/1Cv3V7fHrg7GMH0WGhQyLCdFDHWAToeHW/view?usp=sharing',
    github: "https://github.com/bukhosi-eugene-mpande/Kitchen-of-Secrets",
  },
  {
    num: "02",
    ...
    image: "/assets/work/MM.png",
    live: 'https://drive.google.com/drive/folders/15gAwvIgzDZwYkcwWksYchWsLzhO5vXrd?usp=sharing',
    github: "https://github.com/codingwithThato/Mzansi-Madness-Game-Project",
  },
  {
    num: "03",
    ...
    stack: [{name: 'Figma'}],
    image: "/assets/work/pp.svg",
    live: 'https://www.figma.com/design/z4zED7UTCGfE1ptJ5QHmNS/Final-prototype?node-id=5165-4345&t=iVLh7Uz0PFBjjh7T-1',
    github: "",
  },
  {
    num: "04",
    ...
    image: "/assets/work/FP.svg",
    live: 'https://1-thato.netlify.app/',
    github: "",
  },
  {
    num: "05",
    ...
    stack: [{name: 'C#'}, {name: 'Unity'}],
    image: "/assets/work/AE.png",
    live: 'https://drive.google.com/drive/folders/1mG0BGgM-QsyT_2GMshXf49Jma5lbowTy?usp=share_link',
    github: "https://github.com/codingwithThato/Academia-Escape-Endless-Runner-Game",
  },
  {
    num: "06",
    category: 'UX/UI designer',
    title: 'Portfolio Site',
    description: 'Currently working on a newer personal portfolio website with more attention to detail, to showcase my projects and skills as a developer and designer.',
    stack: [{name: 'Figma'},],
    image: "/assets/work/portfolio.png",
    live: 'https://www.figma.com/design/DKBJqHvIjgEXAgWcTAlMML/PORTFOLIO_NEW_THATO_K?node-id=0-1&t=65nM2bKIkqUYt500-1',
    github: "",
  }
]
